...
admin.site.site_header = "ios2"
admin.site.site_title = "ios2 Admin Portal"
admin.site.index_title = "ios2 Admin"

# swagger
api_info = openapi.Info(
    title="ios2 API",
    default_version="v1",
    description="API documentation for ios2 App",
)
